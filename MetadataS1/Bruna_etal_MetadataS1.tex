...
\resizebox{\linewidth}{!}{
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{8em}>{\raggedright\arraybackslash}p{16em}>{\raggedright\arraybackslash}p{22em}>{\raggedright\arraybackslash}p{3em}}
\toprule
\textbf{Variable} & \textbf{Definition} & \textbf{Codes or Range of Values (Units, Precision)} & \textbf{Storage}\\
\midrule
plot & Plot in which plant is located & FF1-FF7, CF1-CF6 & string\\
\midrule
subplot & Subplot in which plant is located$^{1}$ & A1-E10 in all plots except CF3, where F6-J10 & string\\
\midrule
