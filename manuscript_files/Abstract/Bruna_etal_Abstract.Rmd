...
```{r, out.width = "50%"} 
myurl <- "https://github.com/BrunaLab/HeliconiaSurveys/blob/master/docs/maps/images/bdffpsat.jpg"

download.file(url = myurl, destfile = 'temp.jpg', mode = 'w')

knitr::include_graphics('temp.jpg')
```


![alt text here](https://github.com/BrunaLab/HeliconiaSurveys/blob/master/docs/maps/images/bdffpsat.jpg)
