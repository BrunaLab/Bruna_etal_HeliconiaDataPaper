...
\begin{figure}
\includegraphics[width=0.5\linewidth]{temp} \caption{ }\label{fig:unnamed-chunk-1}
\end{figure}

\begin{figure}
\centering
\includegraphics{https://github.com/BrunaLab/HeliconiaSurveys/blob/master/docs/maps/images/bdffpsat.jpg}
